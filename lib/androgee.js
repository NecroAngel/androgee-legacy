...
class Androgee {
  constructor () {
    ...
    exec('which redis-server', (error, stdout, stderr) => {
      if (error !== null) {
        ...
        console.log('Warning: local Redis not found')
      }
  ...
  checkEnvars () {
    switch (undefined) {
      ...
      case process.env.MINECRAFT_IP:
        throw (new Error('Missing Environment Variable:'))
      case process.env.MINECRAFT_PORT:
        throw (new Error('Missing Environment Variable:'))
      case process.env.MINECRAFT_PASSWORD:
        throw (new Error('Missing Environment Variable:'))
      case process.env.RUST_IP:
        throw (new Error('Missing Environment Variable:'))
      case process.env.RUST_PORT:
        throw (new Error('Missing Environment Variable:'))
      case process.env.RUST_PASSWORD:
        throw (new Error('Missing Environment Variable:'))
      case process.env.GMOD_IP:
        throw (new Error('Missing Environment Variable:'))
      case process.env.GMOD_PORT:
        throw (new Error('Missing Environment Variable:'))
      case process.env.GMOD_PASSWORD:
        throw (new Error('Missing Environment Variable:'))
      case process.env.DEBUG_CHANNEL:
        throw (new Error('Missing Environment Variable:'))
      case process.env.MINECRAFT_CHANNEL:
        throw (new Error('Missing Environment Variable:'))
      case process.env.RUST_CHANNEL:
        throw (new Error('Missing Environment Variable:'))
      case process.env.DEMIGOD_ROLE:
        throw (new Error('Missing Environment Variable:'))
      case process.env.HEROES_ROLE:
        throw (new Error('Missing Environment Variable:'))
      default:
        console.log('Hell Ya')
    }
